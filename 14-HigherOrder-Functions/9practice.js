...
const largerThen100 = nums.find(el => el >100)
...
const oldCars = cars.filter( car => car.make < 2000)
console.log(oldCars)
...
nums1.forEach(logNums)

// function bigNums(a) {
//     if a = nums1.filter( num => num > 1000)
//     return 'Thats a big number!'

// else a = nums1.filter( num => num < 1000)
